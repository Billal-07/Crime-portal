...
function MyState(props) {
    ...
    const addPostHandle = async (e) => {
        ...
        try {
            e.preventDefault();
            const res = await axios.post(`https://crime-data.onrender.com/api/posts/add_post`, formData, {
                headers: {
    ...
    const getAllPosts = async () => {
        setLoading(true);
        try {
            const res = await fetch("https://crime-data.onrender.com/api/posts/getallposts", {
                method: `GET`,
                headers: {
    ...
    const userData = async () => {
        const res = await fetch(`https://crime-data.onrender.com/api/auth/getuser`, {
            method: 'GET',
            headers: {
    ...
    const likeHandler = async (id) => {
        const res = await fetch(`https://crime-data.onrender.com/api/posts/like/${id}`, {
            'method': "PUT",
            headers: {
                'Content-Type': "application/json",
                'auth-token': localStorage.getItem("token")
    ...
    const disLikeHandler = async (id) => {
        const res = await fetch(`https://crime-data.onrender.com/api/posts/dislike/${id}`, {
            'method': "PUT",
            headers: {
                'Content-Type': "application/json",
                'auth-token': localStorage.getItem("token")
    ...
    const getAllComments = async (id) => {
        try {
            const res = await fetch(`https://crime-data.onrender.com/api/posts/getallcomments/${id}`, {
                method: `GET`,
                headers: {
                    'Content-Type': "application/json",
                }
    ...
    const AddComment = async (id) => {
        const res = await fetch(`https://crime-data.onrender.com/api/posts/${id}/comment`, {
            'method': "POST",
            headers: {
                'Content-Type': "application/json",
                'auth-token': localStorage.getItem("token")
    ...
    const getAllUserComments = async () => {
        try {
            const res = await fetch(`https://crime-data.onrender.com/api/posts//getallusercomments`, {
                method: `GET`,
                headers: {
                    'Content-Type': "application/json",
                }
